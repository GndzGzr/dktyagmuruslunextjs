...
const s2 = () => {
    return (
        <div>
            <div className="hidden lg:block bg-[#FFD0EC] px-4 lg:px-64 py-4 lg:py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-8 pt-12">
                    ...
                    <div className="grid grid-cols-1 lg:col-span-3 bg-seans-second h-96 w-full lg:h-screen bg-contain bg-no-repeat bg-center rounded-lg">
                        <div className="lg:px-8" >
                            ...
                            <ul className="px-60 lg:px-0 pt-12 lg:pt-40 text-black text-sm lg:text-xl font-medium lg:list-disc lg:px-8">
            ...
            <div className="block lg:hidden bg-[#FFD0EC] px-4 lg:px-64 py-4 lg:py-12">
                ...
                <div className="grid grid-cols-1 lg:col-span-3 bg-seans-second h-96 w-full lg:h-screen bg-contain bg-no-repeat bg-center rounded-lg">
                        <div className="lg:px-8" >
                            ...
                            <ul className="px-24 sm:px-56 lg:px-0 pt-8 lg:pt-40 text-black text-sm lg:text-xl font-medium lg:list-disc lg:px-8">
                                ...
                                <li className="text-sm lg:text-xl">Amaç: <br></br>Çocuğun normalin dışında olan dil gelişimini standart düzeye getirmek</li>
                            </ul>
